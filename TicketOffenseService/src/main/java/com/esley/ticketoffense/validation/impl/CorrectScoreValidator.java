...
public class CorrectScoreValidator implements ConstraintValidator<CorrectScore, CreateTicketOffenseCommand> {
    ...
    public boolean isValid(CreateTicketOffenseCommand command, ConstraintValidatorContext constraintValidatorContext) {
        ...
        return newOffense.getScoreFrom() <= command.getScore() && newOffense.getScoreTo() >= command.getScore();
    }
}
